  ...
  return (
    <IonContent className="relative">
      ...
      <SafeAreaView className="relative">
        <div className="pt-6 px-4 pb-20 space-y-6">
          {/* Header */}
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={() => router.push(ROUTES.T_ACCOUNT)}
              className="relative p-2 rounded-full bg-white/80 backdrop-blur border border-blue-200"
            >
