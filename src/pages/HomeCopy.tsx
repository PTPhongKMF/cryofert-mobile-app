    ...
    <IonContent className="relative">
      ...
      <SafeAreaView withFixedHeader={true} className="relative">
        <div className="px-4 pb-20">
          ...
          <div className="space-y-6 relative rounded-2xl">
            {/* Quick Actions */}
            <section>
              ...
              <div className="grid grid-cols-2 gap-3">
                {quickActionsArray.map((action) => {
                  const IconComponent = action.icon;
                  return (
                    <button
                      key={action.id}
                      onClick={action.onClick}
                      className="bg-white/80 backdrop-blur rounded-2xl! border border-blue-200 p-4! text-left hover:shadow-md transition-shadow active:scale-[0.98] flex flex-col"
                    >
                      <div
                        className={`${action.color} text-white p-1.5 rounded-lg w-fit mb-2`}
                      >
